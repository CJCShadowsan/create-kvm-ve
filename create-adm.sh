...
virt-install --name $VMNM \
  ...
  --extra-args "ks=file:/$USER-$VEPREFIX-adm.ks console=tty0 console=ttyS0,115200 vehostname=$VMNM ve1st_net=$PRIMARY_NET ve1st_netmask=$PRIMARY_SUBNET_MASK ve1st_gw=$PRIMARY_GW veprefix=$VEPREFIX veclients=4" \
